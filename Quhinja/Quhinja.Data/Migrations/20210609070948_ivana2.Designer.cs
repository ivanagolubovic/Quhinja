...
namespace Quhinja.Data.Migrations
{
    ...
    [Migration("20210609070948_ivana2")]
    partial class ivana2
    {
            ...
            modelBuilder.Entity("Quhinja.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "43c869cc-9413-446a-98a3-da28f5b36bf6",
                            Name = "admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "b9317086-e54a-4477-b053-31d04d062ead",
                            Name = "user",
                            NormalizedName = "USER",
            ...
            modelBuilder.Entity("Quhinja.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "42c7b150-fbd5-423d-a3b8-3ce5b3c2611b",
                            DateOfBirth = new DateTime(2021, 6, 9, 9, 9, 45, 541, DateTimeKind.Local).AddTicks(7087),
                            DateOfEmployment = new DateTime(2021, 6, 9, 9, 9, 45, 554, DateTimeKind.Local).AddTicks(7287),
